...
class Material(Struct):
    ...
    def make_emissive(self, emission_strength: float, replace: bool = False, keep_using_base_color: bool = True,
                      ...
                      color_keyframe = None, strength_keyframe=None):
        ...
        :param color_keyframe: A list of colours to be added as keyframes. Ignored if keep_using_base_color or emission_color are given
        :param strength_keyframe: A list of strength values to be added as keyframes.
        ...
        elif color_keyframe is not None:
            keyframe = 0
            for single_value in color_keyframe:
        ...
        if(strength_keyframe is not None):
            keyframe = 0
            for single_value in strength_keyframe:
                if bpy.context.scene.frame_end < keyframe + 1:
                    bpy.context.scene.frame_end = keyframe + 1
