...
class Shell:
    ...
    @staticmethod
    def sample(center: Union[Vector, np.ndarray, list], radius_min: float, radius_max: float, elevation_min: float, elevation_max: float, uniform_elevation: bool = False,
               number_of_samples=1) -> np.ndarray:
