...
class MaterialManipulator(Module):
    ...
    **Available custom functions**:
    ...
    def _switch_to_emission_shader(self, material: Material, value: dict):
        ...
        material.make_emissive(emission_strength=strength, emission_color=emission_color, replace=True, keep_using_base_color=False,
                               color_keyframe = color_keyframe, strength_keyframe=strength_keyframe)
