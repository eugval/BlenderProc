...
temp_save_folder = '/home/eugene/flow_dataset/'
...
dataset_name = 'textures_ablation'
...
monochrome_image_percent_object = [1.0,0.] #[0.2,0.8]
monochrome_image_percent_distractors = [1.0,0.]
...
light_setting = ['mostly_ambient', 'strong_top_shadow', 'generic_shadow', 'very_bright', 'very_dim']
